...
-- Prüfen, ob auf Mobile (TouchEnabled)
...
-- Fenstergröße & Minimier-Key je nach Gerät
local windowSize = isMobile and UDim2.new(0.9, 0, 0.9, 0) or UDim2.fromOffset(580, 460)
local minimizeKey = isMobile and nil or Enum.KeyCode.LeftControl
